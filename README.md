...
* Importing Libraries plt: Used for creating plots 
* sns: Used for advanced visualization 
* pd: Used for data handling np: Used for numerical operations
* Loading Dataset Loads dataset into a DataFrame Allows easy manipulation and visualization
* Line Plot (Seaborn) Used to visualize trends over time
* Bar Plot Displays comparison between categories
* Histogram Shows distribution of numerical data
* Scatter Plot Displays relationship between variables
* Box Plot Shows median, quartiles, and outliers
* Pair Plot Displays pairwise relationships in dataset
* Heatmap Shows correlation between variables
* Customizing Plots Adjusts size and appearance
